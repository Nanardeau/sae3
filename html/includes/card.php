<div class="card">
    <figure>
        <a href="dproduit.php?id=<?= $article['codeproduit'] ?>">
    ...
    <div>
        ...
        <button class="button" onclick="window.location.href = 'AjouterAuPanier.php?codeProd=<?php echo $article['codeproduit'] ?>&qteProd=1&page=index.php';">Ajouter au panier</button>
        <a class="button" href="dproduit.php?id=<?= $article['codeproduit'] ?>">Détails</a>
    </div>
</div>