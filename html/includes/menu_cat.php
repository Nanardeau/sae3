<nav>
    <div class="navBarCategorie">
    <ul>
    <?php
        $catCurr = null;
        $listCat = $bdd->prepare('SELECT DISTINCT libCat FROM alizon.SousCat');
        $listCat->execute();
    ...
    <div id="overlayMenuCatMob" class="overlayMenuCatMob mob-only">
        <div class="overlayContentCatMob">
            ...
            <div class="page-acc">
                <a href="index.php">Page d'accueil d'Alizon</a>
