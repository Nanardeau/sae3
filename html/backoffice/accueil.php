    ...
    <div class="content-wrapper"> 
        <aside>
            ...
            <div>
                ...
                <?php   
                    echo '<img src="../'.htmlspecialchars($row['urlphoto']).'" alt="Photo de '.htmlspecialchars($row['libelleprod']).'">';
