...
VALUES
    ...
    (
        'Thé noir',
        'Qualité supérieure, fabrique de Carhaix',
        5.60,
        'réduite',
        NULL,
        NULL,
    ...
    (
        ...
        4.90,
        'réduite',
        'Informations de sécurité:Conserver dans un endroit frais et sec',
        'Ingrédients:Café en grains torréfiés',
        'Conseils pour utilisation:Insérez les grains dans le broyeur, puis laissez la machine verser votre café comme vous le souhaitez',
        80,
        'Breizh',
        true,
        10,
...
(
    'Short de sport',
    'Short léger conçu pour une pratique sportive régulière. Son tissu respirant et sa coupe ergonomique offrent un confort optimal, même lors d’efforts intenses. Idéal pour course à pied, fitness ou activités extérieures grâce à sa grande liberté de mouvement.',
    18.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Sweat capuche',
    'Sweat chaud muni d’une capuche ajustable. Fabriqué en coton épais, il offre une grande douceur et une excellente résistance. Sa coupe classique le rend adapté à un usage quotidien, autant pour le confort intérieur que les sorties en extérieur.',
    35.00,
    'super-réduite',
    'TAILLE:S',
    'MATIERE:Coton',
...
(
    'Parka impermeable',
    'Parka longue conçue pour affronter les intempéries. Son revêtement imperméable et sa doublure isolante assurent une protection optimale contre le vent et la pluie. Idéale pour les déplacements quotidiens en saison froide ou pluvieuse.',
    85.00,
    'super-réduite',
    'TAILLE:L',
    'MATIERE:inconnu',
...
(
    'Robe été',
    'Robe légère fabriquée dans un tissu fluide et agréable au toucher. Ses motifs colorés et sa coupe aérée en font une tenue parfaite pour les journées chaudes. Confortable et facile à porter, elle convient aussi bien à la plage qu’aux sorties estivales.',
    28.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Bottes cuir',
    'Bottes en cuir véritable offrant une grande robustesse et une finition élégante. Leur semelle résistante ainsi que leur maintien confortable permettent une utilisation prolongée, que ce soit en ville ou en environnement plus exigeant.',
    110.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Pull laine',
    'Pull tricoté en laine naturelle offrant chaleur et douceur. Sa coupe ajustée et son style intemporel en font un vêtement indispensable pour la saison froide. Fabriqué avec des matériaux de qualité pour garantir longévité et confort.',
    42.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Écharpe douce',
    'Écharpe longue et épaisse conçue pour offrir une chaleur optimale lors des journées froides. Son tissu doux ne pique pas et assure un confort prolongé. Disponible en plusieurs coloris pour s’adapter à tous les styles vestimentaires.',
    16.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Gants hiver',
    'Gants chauds rembourrés, idéals pour faire face aux températures basses. Leur doublure interne assure une isolation efficace tandis que l’extérieur résistant protège du vent. Compatibles avec les écrans tactiles pour une utilisation pratique.',
    14.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Sandales cuir',
    'Sandales élégantes fabriquées en cuir souple de haute qualité. Leur semelle confortable et leur style épuré en font une chaussure idéale pour l’été. Conçues pour offrir un maintien stable lors de la marche.',
    38.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Robe mariniere',
    'Robe marinière élégante et confortable, parfaite pour un look décontracté avec une touche classique et intemporelle.',
    20.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Robe mariniere',
    'Robe marinière fabriquée avec soin dans des matériaux doux et de qualité. Ses rayures emblématiques apportent un style authentique et une note bretonne à votre tenue.',
    20.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Short',
    'Short confortable et léger, parfait pour les journées chaudes ou les activités décontractées.',
    20.00,
    'réduite',
    NULL,
    NULL,
...
(
    'T-shirt femme blanc',
    'T-shirt confortable et polyvalent, idéal pour un look décontracté au quotidien.',
    15.99,
    'réduite',
    NULL,
    NULL,
...
(
    'T-shirt blanc',
    'T-shirt fabriqué avec soin dans un coton doux et respirant, offrant confort et style au quotidien. Parfait pour un look simple et authentique.',
    11.99,
    'réduite',
    NULL,
    NULL,
...
(
    'T-shirt breton premium',
    'T-shirt léger et agréable à porter, parfait pour toutes les occasions décontractées.',
    14.99,
    'réduite',
    NULL,
    NULL,
...
(
    'T-shirt femme',
    'T-shirt confectionné avec des matériaux de qualité, doux et respirant. Idéal pour un confort quotidien tout en gardant un style simple et naturel.',
    18.99,
    'réduite',
    NULL,
    NULL,
...
(
    'T-shirt ptit breton',
    'T-shirt élégant et confortable, parfait pour compléter une tenue décontractée ou habillée.',
    15.99,
    'réduite',
    NULL,
    NULL,
...
(
    'Echarpe bleu et grise',
    'Écharpe douce et élégante, idéale pour vous protéger du froid tout en ajoutant une touche de style à votre tenue.',
    20.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Echarpe bretonne',
    'Écharpe fabriquée avec soin dans des matériaux de qualité, chaude et agréable au toucher. Parfaite pour allier confort et élégance au quotidien.',
    20.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Botte bretonne',
    'Des bottes robustes et confortables, parfaites pour affronter la pluie ou les balades en plein air. Leur design sobre et leur finition soignée en font un indispensable du quotidien.',
    30.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Botte de pluit',
    'Inspirées du style breton, ces bottes imperméables sont parfaites pour les balades en bord de mer ou les jours de pluie. Solides, pratiques et au charme authentique, elles rappellent l’esprit marin de la Bretagne.',
    35.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Botte stylisé',
    'Bottes imperméables et confortables, idéales pour le quotidien ou les escapades bretonnes. Pratiques, solides et stylées !',
    29.99,
    'réduite',
    NULL,
    NULL,
...
(
    'Pull jaune',
    'Un pull confortable et tendance, conçu dans une maille douce pour un maximum de chaleur et de style. Sa couleur jaune apporte une touche de fraîcheur et d’énergie à toutes vos tenues.',
    40.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Short',
    'Un short léger et agréable à porter, parfait pour les journées ensoleillées ou le sport. Sa coupe moderne offre une grande liberté de mouvement tout en restant élégant.',
    30.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Tasse',
    'Une tasse élégante et pratique, idéale pour savourer votre café, thé ou chocolat chaud. Fabriquée dans un matériau résistant, elle allie style et durabilité.',
    3.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Robe bretonne',
    'Robe confectionnée avec soin dans des matériaux de qualité, douce et agréable à porter. Parfaite pour allier confort et style au quotidien.',
    20.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Boîte rangement',
    'Boîte de rangement en plastique robuste, idéale pour organiser vêtements, documents ou jouets. Son couvercle hermétique protège le contenu de la poussière. Adaptée à un usage domestique ou professionnel grâce à sa grande capacité.',
    12.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Bougie parfumée',
    'Bougie coulée à la main avec cire naturelle. Son parfum discret mais durable permet de créer une ambiance apaisante dans n’importe quelle pièce. Le contenant esthétique peut être réutilisé une fois la bougie consommée.',
    9.50,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Moulin poivre',
    'Moulin de table en bois massif, équipé d’un mécanisme de broyage durable. Permet d’ajuster précisément la mouture selon les préférences culinaires. Un accessoire élégant et pratique pour rehausser les saveurs de vos plats.',
    22.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Tapis  de salon',
    'Tapis de salon tissé avec soin, offrant un toucher doux et une excellente résistance à l’usage. Ses motifs modernes permettent d’apporter une touche décorative chaleureuse à votre intérieur tout en assurant une bonne isolation du sol.',
    55.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Plaid laine',
    'Plaid en laine chaude tissé avec une grande finesse. Parfait pour se réchauffer lors des soirées fraîches, il peut également servir d’élément décoratif sur canapé ou lit. Sa texture douce procure une sensation agréable au toucher.',
    39.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Tapis d entrer de Terre de Legende',
    'Tapis d’entrée pratique et résistant, idéal pour garder votre intérieur propre avec style.',
    15.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Tapis d entrer artisanal',
    'Tapis d’entrée fabriqué avec soin dans des matériaux de qualité, robuste et esthétique. Parfait pour accueillir vos invités tout en apportant une touche chaleureuse à votre maison.',
    15.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Tapis d entrer',
    'Tapis d’entrée élégant et pratique, parfait pour protéger votre sol tout en ajoutant une touche déco à votre intérieur.',
    15.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Tapis de souris',
    'Tapis de souris breton pratique et décoratif, parfait pour travailler avec confort tout en ajoutant une touche régionale à votre bureau.',
    15.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Trousse artisanal',
    'Trousse pratique et compacte, idéale pour ranger stylos, maquillage ou petits accessoires au quotidien.',
    12.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Trousse rose',
    'Trousse fabriquée avec soin dans des matériaux de qualité, résistante et élégante. Parfaite pour organiser vos affaires tout en ajoutant une touche authentique à votre quotidien.',
    15.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Trousse bretonne',
    'Trousse élégante et fonctionnelle, parfaite pour garder vos affaires organisées où que vous soyez.',
    13.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Trousse bleu et blanche',
    'Trousse soigneusement conçue avec des matériaux de qualité, pratique et durable. Idéale pour ranger vos essentiels tout en apportant une touche artisanale à votre quotidien.',
    10.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Savon',
    'Savon fabriqué avec soin à partir d’ingrédients naturels, respectueux de la peau. Parfait pour allier hygiène, douceur et authenticité dans votre routine quotidienne.',
    10.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Serviette Breton de coeur',
    'Serviette douce et absorbante, idéale pour le quotidien ou la plage.',
    20.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Serviette',
    'Serviette fabriquée avec soin dans des matériaux de qualité, agréable au toucher et résistante. Parfaite pour allier confort et style dans votre routine quotidienne.',
    15.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Horloge bretonne',
    'Horloge élégante et fonctionnelle, idéale pour décorer votre intérieur tout en gardant l’heure avec style.',
    9.99,
    'réduite',
    NULL,
    NULL,
...
(
    'Horloge de la bretagne',
    'Horloge fabriquée avec soin dans des matériaux de qualité, alliant design et authenticité. Parfaite pour apporter une touche chaleureuse et décorative à votre maison.',
    7.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Statue moulin',
    'Statue de moulin fabriquée avec soin dans des matériaux de qualité, reflétant un style authentique et artisanal. Idéale pour décorer votre espace avec charme et caractère.',
    20.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Bougie bateau',
    'Une bougie élégante qui apporte chaleur et ambiance à votre intérieur. Son parfum délicat et sa flamme douce créent une atmosphère cosy et apaisante.',
    7.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Bougie phare',
    'Illuminez votre maison avec cette bougie raffinée, idéale pour créer une ambiance chaleureuse et relaxante. Parfaite comme objet décoratif ou cadeau original.',
    5.40,
    'réduite',
    NULL,
    NULL,
...
(
    'Bougie bretonne',
    'Une bougie artisanale, fabriquée avec soin à partir de matériaux de qualité. Son parfum subtil et sa flamme douce en font un objet à la fois esthétique et apaisant.',
    7.99,
    'réduite',
    NULL,
    NULL,
...
(
    'Coussin',
    'Coussin décoratif et confortable, idéal pour embellir votre intérieur et profiter d’un confort optimal.',
    15.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Parfum iris',
    'Eau de parfum mêlant notes florales d’iris et touches boisées. Son sillage élégant en fait une fragrance raffinée adaptée aux occasions spéciales. Le flacon soigné met en valeur ce parfum haut de gamme.',
    85.00,
    'normale',
    NULL,
    NULL,
...
(
    'Bracelet argent',
    'Bijou en argent massif travaillé avec finesse. Léger et agréable à porter, il s’adapte à tous les styles vestimentaires. Livré dans un écrin élégant, il constitue également une excellente idée cadeau.',
    70.00,
    'normale',
    NULL,
    NULL,
...
(
    'Lunettes soleil',
    'Lunettes de soleil offrant une excellente protection UV. Leur monture légère et résistante assure un grand confort. Le design moderne et épuré permet de les porter en toutes occasions, été comme hiver.',
    55.00,
    'normale',
    NULL,
    NULL,
...
(
    'Stylo luxe',
    'Stylo haut de gamme au design élégant, doté d’une glisse fluide et régulière. Parfait pour la prise de notes ou la signature de documents importants. Présenté dans un coffret raffiné pour un effet hautement professionnel.',
    45.00,
    'normale',
    NULL,
    NULL,
...
(
    'Savon artisanal',
    'Savon fabriqué à la main avec des huiles végétales de grande qualité. Son parfum discret et naturel en fait un produit agréable au quotidien. Respectueux de la peau, il convient même aux usages fréquents.',
    3.80,
    'réduite',
    NULL,
    NULL,
...
(
    'Trousse toilette',
    'Trousse de toilette spacieuse et résistante conçue pour accueillir tous les essentiels de soin. Son tissu imperméable protège efficacement son contenu. Idéale pour voyages, déplacements ou utilisation quotidienne.',
    14.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Serviette bain',
    'Grande serviette de bain en coton épais, absorbante et douce au contact de la peau. Durable et résistante, elle conserve ses qualités lavage après lavage. Disponible dans plusieurs coloris.',
    18.50,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Peignoir coton',
    'Peignoir confortable en coton moelleux conçu pour envelopper le corps d’une chaleur agréable après la douche. Son tissu épais assure une absorption optimale et une douceur durable.',
    45.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Vase breton',
    'Vase breton fabriqué avec soin dans des matériaux de qualité, orné de motifs inspirés de la culture bretonne. Parfait pour apporter une note traditionnelle et chaleureuse à votre décoration.',
    95.00,
    'normale',
    NULL,
    NULL,
...
(
    'Carafe verre',
    'Carafe en verre soufflé à la bouche, offrant une grande transparence et une élégance naturelle. Idéale pour servir eau, vin ou jus lors des repas. Sa forme ergonomique assure une prise en main confortable.',
    28.00,
    'normale',
    NULL,
    NULL,
...
(
    'Tapis de yoga',
    'Tapis de yoga antidérapant offrant une excellente adhérence au sol. Son épaisseur confortable réduit les impacts et assure un maintien stable pour toutes les postures. Idéal pour yoga, pilates et étirements.',
    24.00,
    'super-réduite',
    'LONGUEUR:1m80',
    'MATIERE:caoutchouc',
...
(
    'Bouteille sport',
    'Bouteille de sport légère conçue dans un plastique sans BPA. Son embout étanche et son format pratique permettent de l’emporter partout : salle de sport, bureau ou sorties extérieures.',
    8.50,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Tente randonnée',
    'Tente légère adaptée aux randonnées et bivouacs courts. Son montage rapide et sa toile résistante aux intempéries offrent un abri fiable. Compacte et facile à transporter, elle convient parfaitement aux excursions régulières.',
    75.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Sac couchage',
    'Sac de couchage conçu pour offrir une bonne isolation thermique lors des nuits fraîches. Sa forme enveloppante assure un confort optimal et limite les déperditions de chaleur. Livré avec housse de compression.',
    55.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Boussole pro',
    'Boussole de randonnée précise et résistante, dotée d’un cadran lumineux pour une lecture facile, même par faible luminosité. Un outil fiable pour les passionnés d’orientation et les explorateurs.',
    16.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Lampe torche',
    'Lampe torche compacte équipée d’une LED très puissante assurant une excellente visibilité de nuit. Son autonomie longue durée en fait un accessoire incontournable en randonnée, camping ou dépannage.',
    12.90,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Gourde thermique',
    'Gourde isotherme capable de conserver la chaleur ou la fraîcheur pendant plusieurs heures. Son revêtement robuste la protège des chocs et assure une étanchéité parfaite pour un transport sécurisé.',
    22.00,
    'super-réduite',
    NULL,
    NULL,
...
(
    'Gourde',
    'Gourde pratique et durable, idéale pour rester hydraté partout, à la maison, au travail ou en balade.',
    15.00,
    'réduite',
    NULL,
    NULL,
...
(
    'Termos',
    'Termos fabriquée avec des matériaux de qualité, résistante et agréable à utiliser. Parfaite pour allier confort, praticité et style au quotidien.',
    10.99,
    'réduite',
    NULL,
    NULL,
