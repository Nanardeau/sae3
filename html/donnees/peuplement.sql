...
('Ventilateur', 'Ventilateur de table compact conçu pour offrir un flux d’air rafraîchissant tout en restant silencieux. Son format réduit le rend idéal pour le bureau ou la chambre.', 22.00, 'super-réduite', 0.25, 0.20, 0.15, 35, 'France', 5, '/img/ventilateur.jpg', 6, 'tarif2'),
('Radiateur soufflant', 'Radiateur soufflant portable offrant une montée en température rapide pour réchauffer une pièce de petite taille. Compact, léger et équipé d’une sécurité thermique, il s’avère idéal pour une utilisation ponctuelle en hiver.', 34.00, 'super-réduite', 0.30, 0.25, 0.20, 28, 'France', 5, '/img/radiateur.jpg', 8, 'tarif2'),
('Mini aspirateur', 'Aspirateur de petite taille conçu pour les surfaces réduites et les intérieurs de voiture. Sa puissance étonnante pour son format permet de capturer poussières et miettes efficacement. Facile à ranger grâce à son faible encombrement.', 27.00, 'super-réduite', 0.20, 0.25, 0.15, 40, 'Étranger', 5, '/img/aspirateur.jpg', 5, 'tarif1'),
...
('Chaise pliante', 'Chaise pliante légère idéale pour camping, pique-nique ou plage. Sa structure en aluminium assure robustesse et simplicité de transport. Le tissu respirant offre un confort appréciable même par temps chaud.', 28.00, 'super-réduite', 0.80, 0.45, 0.40, 22, 'France', 5, '/img/chaise.jpg', 8, 'tarif3'),
...
('Sac banane', 'Sac banane pratique pour ranger téléphone, clés ou portefeuille lors d’activités sportives ou déplacements rapides. Sa sangle ajustable permet un maintien confortable en toute situation.', 14.00, 'super-réduite', NULL, NULL, NULL, 60, 'France', 8, '/img/banane.jpg', 5, 'tarif1'),
...
('Casque audio', 'Casque audio léger offrant un son clair et immersif. Son arceau réglable et ses coussinets confortables le rendent agréable à porter même lors d’écoutes prolongées. Compatible avec la plupart des appareils modernes.', 48.00, 'super-réduite', NULL, NULL, NULL, 40, 'France', 5, '/img/casque.jpg', 6, 'tarif1'),
('Enceinte portable', 'Enceinte Bluetooth compacte dotée d’une très bonne autonomie. Malgré sa petite taille, elle offre un son puissant et équilibré. Idéale pour soirées, voyages ou séances sportives en extérieur.', 36.00, 'super-réduite', 0.12, 0.10, 0.10, 50, 'France', 5, '/img/enceinte.jpg', 8, 'tarif1'),
('Chargeur rapide', 'Chargeur USB haute vitesse compatible avec la majorité des smartphones. Léger et compact, il assure un chargement optimisé tout en protégeant l’appareil grâce à son système anti-surchauffe.', 15.00, 'super-réduite', NULL, NULL, NULL, 100, 'Breizh', 6, '/img/chargeur.jpg', 5, 'tarif1');
