        ...
        ?>
            ...
            ?><article><?php
                        ...
                        <div class="card">
                            ...
                            <div>
                                <a><svg width="19" height="21" viewBox="0 0 19 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="dproduit.php?id=<?= $produit['id'] ?>"><input type="button" value="Détails" href="dproduit.php?id=<?= $produit['id'] ?>"></input></a>
                            </div>
